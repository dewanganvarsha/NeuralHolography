"""
This code is adapted from Technical Paper:
...
def phasemap_8bit_tensor(phasemap, inverted=True):
    """convert a phasemap tensor into a 8bit phasemap 
    ...
    if inverted:
        phase_out_8bit = ((1 - output_phase) * 255).round()  # quantized to 8 bits
    else:
        phase_out_8bit = ((output_phase) * 255).round() # quantized to 8 bits
